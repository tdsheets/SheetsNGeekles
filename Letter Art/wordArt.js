...
function createDivs(length) {
   ...
   //Expand the mat around the divs so they are centered within the frame
   ...
   /* TO DO - NEED TO CHANGE THIS CALCULATION TO SOMETHING MORE RESPONSIVE-FRIENDLY */
...
//calls the setWord function when user hits enter, stops page from reloading
